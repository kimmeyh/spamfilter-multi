...
Checks heuristic database (`.Codex/model_assignment_heuristics.json`) for prior similar tasks:
...
The skill reads from: `.Codex/model_assignment_heuristics.json`
...
- **.Codex/model_assignment_heuristics.json** - Heuristic database
