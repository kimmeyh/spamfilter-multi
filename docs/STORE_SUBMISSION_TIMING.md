...
|---|---|---|---|---|
| (number NOT observed) | 0.16.0.0 | 2026-09-24, between 12:17am ET (MSIX built + verified, handed to Harold) and 8:39am ET (Harold's message: "Microsoft Store and Google Play rollouts of 0.16.0 are in process"). Exact upload time NOT observed -- do not infer one. | pending | -- |
