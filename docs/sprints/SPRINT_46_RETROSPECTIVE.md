...
- **IMP-3 -- CHANGELOG-per-commit discipline** (Claude Cat 8/9): Harold: per-commit "seems too often" -- asked for the next 2 best alternatives. Alternatives presented (per-completed-item vs Phase-5-entry gate); **decision pending.**
