...
3. **Task 6** (Class 1): the parity ADR presented for approval before Tasks 7 and 8 treat it as binding. -- **AWAITING: Harold's answer arrived truncated ("3/ dpm"). Re-asking rather than guessing.**
4. **Sprint size**: 9 tasks at ~17-27 hours is larger than recent sprints. Confirm, or drop the largest (Task 8, F161) to a following sprint. -- **AWAITING.**
