...
cd d:\Data\Harold\github\spamfilter-multi\mobile-app; flutter analyze # typically after test
...
IMPLEMENTATION_SUMMARY.md (verification + manual test results + fixes).
